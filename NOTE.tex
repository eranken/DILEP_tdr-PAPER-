...
\title{Measuring the top quark Yukawa coupling using kinematics of \ttbar dilepton decays using full run 2 data}
...
pdftitle={Etraction of top Yukawa from tt kinematic distributions in the dilepton channel},
pdfsubject={CMS},
